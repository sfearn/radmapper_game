...
FONT_SIZE = 24
COUNTDOWN_SECONDS = 20  # Set countdown timer (60 seconds)
...
def main():
    ...
    while not game_over:
        ...
        if 0 <= new_car_x < GRID_WIDTH and 0 <= new_car_y < GRID_HEIGHT and (new_car_x, new_car_y) not in walls.walls:
            ...
            count_data[car_y, car_x] = max(count_data[car_y, car_x],
                                           10000 / max(1, distance_squared(car_x, car_y, source_x, source_y)))
